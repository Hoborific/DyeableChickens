...
public class RenderDyeableChicken extends RenderLiving<EntityDyeableChicken> {
    private static final ResourceLocation CHICKEN_TEXTURES =   new ResourceLocation(DyeableChickens.MODID+":textures/entity/dyeablechicken/chicken_base.png");//new ResourceLocation("textures/entity/chicken.png");
    public static final ResourceLocation CHICKEN_COAT_TEXTURES = new ResourceLocation(DyeableChickens.MODID+":textures/entity/dyeablechicken/chicken_coat.png"); //
